...
public class GoalColumnDefinition {
    ...
    private boolean includeInInputSheet;
    ...
    public GoalColumnDefinition(String columnName, String columnType, String linkedGoalName, Integer columnOrder, Integer columnGoalOrder,
                                      boolean columnLocked, boolean includeInInputSheet, String defaultValue, String selectionFile, String regionException1,
        ...
        this.includeInInputSheet = includeInInputSheet;
    ...
    public boolean isIncludeInInputSheet() {
        return includeInInputSheet;
    }

    public void setIncludeInInputSheet(boolean includeInInputSheet) {
        this.includeInInputSheet = includeInInputSheet;
    }
