...
public class Main {
    ...
    public static void main(String[] args) throws IOException, InvalidFormatException {
        ...
        //  THERE IS TWO WAYS TO PULL ELIGIBILE EMPLOYEES.  EITHER VIA THE CSV OR VIA WORKDAY REPORT.  UNCOMMENT THE REQUIRED WAY.
        //  FUNCTION BELOW WILL PULL ELIGIBLE EMPLOYEES FROM THE WORKDAY REPORT VIA THE WSDL
        final String wdUser = "120529@americanheart";
        final String wdPassword = "Smile@247";
        final String wdEndpoint = "https://wd2-impl-services1.workday.com/ccx/service/Report2/americanheart/120529/Incentive__Input_Template_Report_-_BNL?wsdl";

        employeeIncentiveInputs = SettingImports.GetWorkdayEligibleEmployees(wdUser,wdPassword,wdEndpoint);
        //  FUNCTION BELOW WILL PULL ELIGIBLE EMPLOYEES FROM THE CSV FILE THAT IS A RESULT OF THE WORKDAY REPORT
//        employeeIncentiveInputs = SettingImports.OpenEmployeeImportCSV("d://incentive//Incentive_Input_File.csv");

        System.out.println("Number of eligible employees from main:"+employeeIncentiveInputs.size());
